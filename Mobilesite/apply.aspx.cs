...
public partial class apply : System.Web.UI.Page
{
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            tcandidate.yearOfExperience = Convert.ToInt32(years.Text);
        }
        catch {
        ...
        string loginUrl = "https://masterdemocn.hiringboss.com/careersiteSubmitCandidate.do";
    ...
    {
        string strURL = "https://masterdemocn.hiringboss.com/careersiteSubmitCandidate.do";
